...
export default function Form() {
    return (
        ...
        <div class="w-full">
        <div class="mx-auto max-w-full rounded-3xl bg-gradient-to-br from-pink-400 to-sky-200 p-6 px-10 dark:bg-gradient-to-br dark:from-pink-700
         dark:to-sky-500/30 sm:max-w-[500px] sm:p-[60px]">
          ...
          <form className="md:text-md text-xs text-black dark:text-white sm:text-sm ">
            ...
            <div class="flex w-full">
               ...
               <select id="country-code" name="country-code" class="w-full rounded-3xl border py-2 px-5 text-body-color placeholder-body-color shadow-one outline-none
                focus:border-primary focus-visible:shadow-none dark:bg-white sm:border-transparent sm:py-3" required="">
               ...
               <option value="+967-YE">YE +967</option><option value="+262-YT">YT +262</option><option value="undefined-YU">YU </option><option value="+27-ZA">ZA +27</option><option value="+260-ZM">ZM +260</option><option value="undefined-ZR">ZR </option><option value="+263-ZW">ZW +263</option>
               </select>
             </div>
               ...
               <div class="mb-3 flex-grow sm:mb-6">
                ...
                <input id="phone" placeholder="Enter your Phone Number" class="w-full rounded-3xl border py-2 px-5 text-body-color  placeholder-body-color 
                shadow-one outline-none focus:border-primary focus-visible:shadow-none dark:bg-white sm:py-3" required="" pattern="\d{9,13}" title="Please enter a valid phone number with 9 to 13 digits" type="tel" value="" name="phone" />
               </div>
         </div>
